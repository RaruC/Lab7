...
public class Main
{
    public static void main(String[] args)
    {
        ...
        System.out.println("\nAdvanced Level:\n");
        System.out.println("Cel mai mare volum: " + GeometricBodyController.getBiggestSurfaceBody(bodies).getSurface());
        System.out.println("Cea mai mare suprafata: " + GeometricBodyController.getBiggestVolumeBody(bodies).getVolume());
